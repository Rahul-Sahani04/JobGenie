...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'bg-transparent border border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-primary-500 disabled:text-gray-400',
    text: 'bg-transparent text-primary-600 hover:bg-gray-50 focus:ring-primary-500 disabled:text-gray-400',
